...
class ReusableTable6 extends StatefulWidget {
  ...
  @override
  _ReusableTable6State createState() => _ReusableTable6State();
}

class _ReusableTable6State extends State<ReusableTable6> {
