...
class TopCompletedGrn extends StatefulWidget {
  ...
  @override
  State<TopCompletedGrn> createState() => _TopCompletedGrnState();
}

class _TopCompletedGrnState extends State<TopCompletedGrn> {
  List allData = [];
  bool addOrder = false;
  var supplierId;
  @override
